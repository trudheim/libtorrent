...
#define TEST_AI_INIT(name)                                              \
  ...
  auto ai_hint_numerichost = torrent::ai_make_hint(AI_NUMERICHOST, 0, 0); \
  const auto c_ai_hint_numerichost = torrent::ai_make_hint(AI_NUMERICHOST, 0, 0); \
  auto ai_hint_numerichost_in = torrent::ai_make_hint(AI_NUMERICHOST, AF_INET, 0); \
  auto ai_hint_numerichost_in6 = torrent::ai_make_hint(AI_NUMERICHOST, AF_INET6, 0);
